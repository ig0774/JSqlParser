...
public class CCJSqlParser implements CCJSqlParserConstants {
    ...
    final public Column Column() throws ParseException {
        ...
        String name2 = null;
        String name3 = null;
        TokenPosition name1_position = null;
        TokenPosition name2_position = null;
        TokenPosition name3_position = null;
        TokenPosition col_position = null;
        // [schema.][tabella.]colonna
        name1 = RelObjectName();
        name1_position = TokenPosition.copy(token);
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
        case 84:
            jj_consume_token(84);
            name2 = RelObjectName();
            name2_position = TokenPosition.copy(token);
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case 84:
                jj_consume_token(84);
                name3 = RelObjectName();
                name3_position = TokenPosition.copy(token);
                break;
            default:
                jj_la1[21] = jj_gen;
                ;
        ...
        if (name3 != null) {
            ...
            table.setNamePosition(name2_position);

            col_position = name3_position;
            colName = name3;
        } else if (name2 != null) {
            table = new Table(null, name1);
            table.setNamePosition(name1_position);

            col_position = name2_position;
            colName = name2;
        } else {
            table = new Table(null, null);
            col_position = name1_position;
            colName = name1;
        }
        Column column = new Column(table, colName);
        column.setNamePosition(col_position);
        {
            if (true)
                return column;
        }
    ...
    final public Table Table() throws ParseException {
        ...
        if (jj_2_4(3)) {
            ...
            jj_consume_token(84);
            name2 = RelObjectName();
            position = TokenPosition.copy(token);
            table = new Table(name1, name2);
            table.setNamePosition(position);
        } else {
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case S_IDENTIFIER:
            case S_QUOTED_IDENTIFIER:
    ...
    final public List IntoClause() throws ParseException {
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x4000000, 0x0, 0x0, 0x0, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x20, 0x0, 0x0, 0x0,
                0x800, 0x1000, 0x1000, 0x80000, 0x400000, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000, 0x1000, 0x0, 0x1000, 0x1000, 0x0, 0x0, 0x1000, 0x1000, 0x0, 0x1000, 0x1000, 0x0, 0x0, 0x0, 0x0,
                0x20, 0x0, 0x80800000, 0x20, 0x0, 0x0, 0x0, 0x20, 0x18000000, 0x10000000, 0x10000000, 0x0, 0x0, 0x8000000, 0x0, 0x800, 0x800, 0x0, 0x0, 0x240000, 0x240000, 0x0, 0x0, 0x0, 0x1000, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x10000, 0x10000, 0x10000, 0x10000, 0x80815000, 0x10000, 0x0, 0x0, 0x80800000, 0x10000, 0x80800000, 0x10000, 0x10000, 0x0, 0x10000, 0x10000, 0x0, 0x0, 0x80805000,
                0x4000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80800000, 0x0, 0x0, 0x0, 0x0,
                0x1000, 0x1000, 0x80800000, 0x80801000, 0x0, 0x818000, 0x818000, 0x0, 0x818000, 0x8000, 0x818000, 0x0, 0x0, 0x0, 0x0, 0x818000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x86380020, 0x0, 0x0, 0x80, 0x0, 0x0, 0x0, 0x8040000, 0x8040000, 0x0, 0x8240000, 0x8240000, 0x0, 0x0, 0x8040000, 0x8040000, 0x0, 0x0, 0x8240000, 0x0, 0x80, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x20, 0x200000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x400, 0x1000000, 0x10000, 0x404000, 0x0, 0x0, 0x200, 0x0, 0x0, 0x10000, 0x404000, 0x0, 0x0, 0x200, 0x0, 0x0,
                0x200000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x200000, 0x0, 0x0, 0x4002a010, 0x40020010, 0x40020010, 0xa000, 0xa000, 0x0, 0x0, 0x100, 0x100, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x400000, 0x404000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80000008, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x80000000, 0x0, 0x0, 0x10000000, 0x0, 0x0, 0x0, 0x0, 0x80000008, 0x8,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x4, 0x1, 0x4, 0x80000001, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x0,
                0x80000000, 0x80000000, 0x0, 0x20000000, 0x20000000, 0x0, 0x20000000, 0x20001000, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x1040, 0x0, };
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[] { 0x40002, 0x8000, 0x20000, 0x0, 0x0, 0x20000, 0x20000, 0x0, 0x0, 0x20000, 0x40000, 0x40000, 0x0, 0x20000, 0x0, 0x0, 0x20000, 0x80000, 0x40000, 0x0, 0x0, 0x100000,
                0x100000, 0x4200, 0x4200, 0x4200, 0x0, 0x0, 0x0, 0x4, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x4, 0x0, 0x4, 0x4, 0x0, 0x0, 0x4, 0x4, 0x0, 0x4, 0x4, 0x40000, 0x20000,
                0x40000, 0x20000, 0x4200, 0x200000, 0x446230, 0x0, 0x20000, 0x40000, 0x44200, 0x4200, 0x20000, 0x0, 0x0, 0x0, 0x0, 0x20000, 0x20000, 0x0, 0x0, 0x20000, 0x20000, 0x0, 0x0, 0x400020,
                0x400020, 0x400020, 0x400020, 0x400020, 0x0, 0x0, 0x400020, 0x40000, 0x0, 0x40000, 0x0, 0x40000, 0x446230, 0x0, 0x18000000, 0x3f810000, 0x446230, 0x0, 0x446230, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x20000, 0x20000, 0x446230, 0x0, 0x40000, 0x40000000, 0x80000000, 0x0, 0x40000, 0x200000, 0x40000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x400000,
                0x42000, 0x0, 0x0, 0x0, 0x0, 0x446230, 0x0, 0x4200, 0x100000, 0x100000, 0x4, 0x4, 0x646230, 0x646234, 0x0, 0x52230, 0x52230, 0x20000, 0x52230, 0x200, 0x52230, 0x40000, 0x2020, 0x2020,
                0x20000, 0x52230, 0x2230, 0x2230, 0x20000, 0x20000, 0x200, 0x200, };
    }
    ...
    private static void jj_la1_init_3() {
        jj_la1_3 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3a6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3a6, 0x0, 0x0, 0x0, 0x3a6, 0x0, 0x3a6, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3a6,
                0x0, 0x0, 0x0, 0x1, 0x6, 0x0, 0x8, 0x0, 0x10, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x6, 0x0, 0x1a6, 0x0, 0x0, 0x0, 0x0, 0x3a6, 0x200, 0x0, 0x0, 0x0, 0x0, 0x0, 0x3a6,
                0x3a6, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }
    ...
    public CCJSqlParser(java.io.Reader stream) {
        jj_input_stream = new OffsetCharStream(stream, 1, 1);
        token_source = new OffsetTokenManager((OffsetCharStream)jj_input_stream);
        token = new Token();
        jj_ntk = -1;
        jj_gen = 0;
        for (int i = 0; i < 158; i++)
